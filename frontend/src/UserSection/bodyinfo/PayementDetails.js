...
class Paiementcond extends Component{
    render(){
        const {NumberOfCodeSessions,NumberOfDrivingSessions,NumberOfCodeExams,NumberOfDrivingExams,AmountPaid,RemainingPayment}=this.props
        return(
            <div>
                <fieldset className='paiementcond'>
                    <legend><h1>Payement Details </h1></legend>
                    <table>
                        <tbody>
                            <tr>
