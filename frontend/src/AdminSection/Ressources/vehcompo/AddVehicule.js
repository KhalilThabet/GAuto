...
export default function Ajouteveh() {
    ...
    const HandleSubmit = () => {
        ...
        var TempNumberOfHorses = document.getElementById('TempNumberOfHorses').value;
        const data = {
        ...
        if (TempRegisterPlate===""){alert("l operation est inccorect !");}
        else{
                ...
                <table>
                    <tbody>
                        <tr>
                            ...
                            <td><input type='text' id='TempRegisterPlate'></input> </td>
                            <td>Model :</td>
                            <td><input type='text' id='TempModel'></input> </td>
                        </tr>
                        <tr>
                            <td>Brand :</td>
                            <td><input type='text' id='TempBrand'></input> </td>

                        </tr>
                        <tr>
                            <td>N° Of Horses :</td>
                            <td><input type='text' id='TempNumberOfHorses'></input> </td>
